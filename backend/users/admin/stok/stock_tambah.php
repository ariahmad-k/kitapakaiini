...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM stok_harian WHERE id_produk='$id_produk' AND tanggal='$tanggal'");
    if (mysqli_num_rows($cek) > 0) {
        mysqli_query($koneksi, "UPDATE stok_harian SET stok='$stok' WHERE id_produk='$id_produk' AND tanggal='$tanggal'");
    } else {
        mysqli_query($koneksi, "INSERT INTO stok_harian (id_produk, tanggal, stok) VALUES ('$id_produk', '$tanggal', '$stok')");
    }
                        ...
                        <div class="col-12 mb-3">
                            <form method="POST">
                                ...
                                <form method="GET" action="">
                                    ...
                                    <input type="date" name="stok" id="stok" value="<?= $hari ?>" required>
                                </form><br>
