        ...
        <div class="tracking-result-container">
            <?php if ($hasil_lacak): ?>
                ...
                <?php
                    ...
                    $steps = [
                        'menunggu_pembayaran' => ['label' => 'Pesanan Masuk', 'icon' => 'receipt'],
                        'menunggu_konfirmasi' => ['label' => 'Menunggu Konfirmasi', 'icon' => 'hourglass-half'],
                        'dibatalkan'          => ['label' => 'Pembayaran Ditolak', 'icon' => 'times-circle']
                        ];
                    } else {
                    // Flow normal 
                    $steps = [
                        ...
                        'selesai'             => ['label' => 'Siap Diambil', 'icon' => 'check-circle']
                        ];
                    }
            ...
            <ul class="list-group">
                <?php foreach ($antrean_publik as $antrean): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <?php else: ?>
                            <span class="badge bg-danger rounded-pill">Menunggu</span>
                        <?php endif; ?>
                    </li>
                <?php endforeach; ?>
            </ul>
